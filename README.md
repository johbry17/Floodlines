...
_Screenshots forthcoming. Suggested captures:_

- **Default view — Quadrant map:** All Vermont towns classified into funding quadrants (underfunded, overfunded, aligned, low-priority, zero-funding)
- **Need index choropleth:** Rank-based composite of flood exposure and social vulnerability, with river corridor overlay
...
- **Relative toggle — EAL risk:** Same map rescaled to show deviation from the Vermont statewide average rather than absolute percentile rank
